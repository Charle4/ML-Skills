...
- Look for saturation or missing headroom, noisy or seed-sensitive rankings, leakage, silent candidate crashes, and failure paths that disappear instead of receiving an explicit failed/inconclusive status or penalty.
